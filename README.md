...
### [Big Data Crime Analysis — LAPD Dataset (1M+ rows)](https://github.com/FareSghaier/BigData-LAPD-CrimeAnalysis)
Full big data pipeline on 1,004,991 real LAPD crime records using **Apache Spark** and **Hadoop**.
Two-stage cleaning pipeline (Pandas + PySpark), 7 Spark transformations, DataFrame–RDD joins, and partitioned CSV output.
...
**TF-IDF** vectorization · Deep **Autoencoder** (5000→128, Keras) · cost-sensitive **Logistic Regression** (97.8% accuracy, 91.8% F1) · **BERT** extension (HuggingFace + PyTorch).

### [Java Data Processing — Student Grade Analytics](https://github.com/FareSghaier/UA3-ProgrammationAvancee)
Object-oriented Java application: CSV ingestion → grade computation → student ranking → results export.
Full collaborative workflow with structured GitHub commits and technical documentation.
